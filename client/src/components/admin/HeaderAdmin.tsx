            ...
            <nav>
                <div className="navbar bg-base-100 ">
                    <div className="flex-1">
                        ...
                        <Link to="/user/admin/products"> <a className="btn btn-ghost normal-case text-sm">Users</a> </Link>
                        <Link to="/user/admin/products"> <a className="btn btn-ghost normal-case text-sm">Orders</a> </Link>
                    </div>
